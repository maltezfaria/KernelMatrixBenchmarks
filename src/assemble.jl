...
"""
function pyassemble(tag::String,X,Y;nmax=200,eta=3,threads=false)
    ...
    t = @elapsed begin
        ...
        hmat = assemble_hmat(K,Xclt,Yclt;adm,global_index=false,threads)
    end
    @debug "assemble time: $t seconds"
    return hmat
end
